                ...
                <div className={`${userInfo.name === '' ? 'hidden' : 'block'} w-[100%]`}>
                    ...
                    <div className="footer-info">
                        <div className={`footer-info-divs ${userInfo.location === null ? 'opacity-50' : 'opacity-100'}`}>
                            ...
                            <h1 className={`ml-[6px]`}>{userInfo.location === null ? 'Not Available' : userInfo.location}</h1>
                        </div>
                        <div className={`footer-info-divs ${userInfo.blog === "" ? 'opacity-50' : 'opacity-100'}`}>
                            ...
                            <h1 className={`${userInfo.blog === "" ? '' : 'hover:underline'}`}>{userInfo.blog === "" ? 'Not Available' : 
